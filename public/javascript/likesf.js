...
function like_add (postId) {
  ...
  if (u[lastIndex + 1] == 'p' && u[lastIndex + 2] == 'r' && u[lastIndex + 3] == 'o') { u = u.substr(0, u.lastIndexOf('/')) + '/post/' + postId + '/like' } else {
...
function remove_like (postId) {
  ...
  lastIndex = u.lastIndexOf('/')
  if (u[lastIndex + 1] == 'p' && u[lastIndex + 2] == 'r' && u[lastIndex + 3] == 'o') { u = u.substr(0, u.lastIndexOf('/')) + '/post/' + postId + '/unlike' } else {
